...
const policyContents = {
  terms: {
    ...
    content: `
      ...
      <p>The lifetime software license is priced transparently at <strong>₹599 INR</strong> (inclusive of all digital processing charges). Payments are secured via UPI and PCI-DSS compliant gateways.</p>
  ...
  privacy: {
    ...
    content: `
      ...
      <p>All digital payments of ₹599 are conducted directly via authorized UPI networks (NPCI / RBI) and PCI-DSS Level 1 compliant gateways. We never see or store your UPI PINs, passwords, or card CVVs.</p>
      
      <h4>3. Transaction Data Collected</h4>
      <ul>
        <li>Order ID & Payment ID for transaction verification, license activation, and invoice generation.</li>
        <li>User email address for delivering digital license keys and customer support receipts.</li>
      </ul>
  ...
  refund: {
    ...
    content: `
      ...
      <p>Send an email to <strong>itzgarry01@gmail.com</strong> or WhatsApp <strong>+91 62392 45940</strong> with your Payment ID and description.</p>
  ...
  shipping: {
    ...
    content: `
      ...
      <ul>
        <li><strong>Automatic Extension Download:</strong> Download of <code>agristack-card-helper-v2.0.zip</code> begins automatically in your web browser within <strong>0–5 seconds</strong> of successful payment confirmation.</li>
        <li><strong>License Keys & Receipts:</strong> Delivered instantly on-screen and to your provided email address.</li>
      </ul>
